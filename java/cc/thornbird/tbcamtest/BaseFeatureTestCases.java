...
public class BaseFeatureTestCases implements CamTestCases {
    private static final String TAG = "TBCamTest_BaseFeatureTestCases";
    private CamTestReport mCamTestReport = null;
    private final int BaseTestCaseNum = 3;
    ...
    public BaseFeatureTestCases(CameraInfoCache mCIF)
    {
